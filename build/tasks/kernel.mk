...
#   TARGET_KERNEL_SDCLANG_COMPILE      = Compile kernel with snapdragon clang, defaults to true
#
...
ifneq ($(TARGET_KERNEL_CLANG_COMPILE),false)
    ...
    else ifneq ($(TARGET_KERNEL_SDCLANG_COMPILE),false)
        TARGET_KERNEL_CLANG_PATH ?= $(BUILD_TOP)/vendor/qcom/sdclang/compiler
    else
        # Use the default version of clang if TARGET_KERNEL_CLANG_VERSION hasn't been set by the device config and sdclang is disabled
